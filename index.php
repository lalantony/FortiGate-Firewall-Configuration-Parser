...
<!-- START OF HEADER -->
                   ...
                   <div id="header">
                         ...
                         <div id="get-app">
							   ...
							   <!-- get the app button -->
                               <button class="btn_process" type="submit" name="btnprocess" value="submit">
  <img src="design/layout/button.jpg" alt"Process" />
</button>
                     ...
                     <div  class="background" id="footer">
                            <div class="container">
                                      ...
                                      <ul id="social">
                                          ...
                                          <!-- Twitter link -->
                                      <button type="button" class="btn btn-twitter" value="Page" onclick="location.href='https://twitter.com/lal_antony/';"><i class="icon-twitter"></i></button>
                                        <button type="button" class="btn btn-linkedin" value="Page" onclick="location.href='http://au.linkedin.com/in/lalantony';"><i class="icon-linkedin"></i></button>
